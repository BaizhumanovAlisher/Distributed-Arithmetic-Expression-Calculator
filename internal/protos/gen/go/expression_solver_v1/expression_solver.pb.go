...
func (x *ExpressionResponse) GetExpressionId() int32 {
	if x != nil {
...
func (x *Calculator) GetResourceId() int32 {
	if x != nil {
		return x.ResourceId
	}
	return 0
...
var file_expression_solver_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f,
	...
	0x05, 0x52, 0x0a, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x4c, 0x0a,
